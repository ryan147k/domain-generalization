...
def parse_option():
    ...
    parser.add_argument('--sd', nargs='+', default=['C', 'P', 'R'], help='source domains')
    parser.add_argument('--td', type=str, default='A', help='target domain')
